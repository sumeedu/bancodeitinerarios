          ...
          <div className="flex justify-between h-16">
            ...
            <div className='flex'>
              ...
              {auth.user ? (
                ...
                <div className="ml-3 relative">
                  <Link href={route('login')} className="btn px-6 py-2.5 bg-gray-100 text-gray-700 text-xs leading-tight uppercase rounded  hover:bg-blue-700 hover:text-gray-50 hover:shadow-lg focus:bg-blue-700  focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out flex items-center">
                    Login
                  </Link>
                </div>
              )}
