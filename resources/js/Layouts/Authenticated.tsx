              ...
              <div className="xl:w-96">
                <form method="GET" action={route('itineraries.index')}>
                  <div className="input-group relative flex items-stretch w-full">
                    ...
                    <button className="btn px-6 py-2.5 bg-gray-100 text-slate-500 hover:text-gray-50 leading-tight rounded rounded-l-none hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700  focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out flex items-center" type="submit">
